  ...
  const detailComponent={
		  ...
		  template:` <h3 class="text-center">맛집 상세보기</h3>
		  		     <table class="table">
		  		       ...
		  		       <tr>
		  		         <th width="15%">주소</th>
		  		         <th width="55%">{{food_detail.address}}</td>
		  		       </tr>
		  		       <tr>
		  		         <th width="15%">전화</th>
		  		         <th width="55%">{{food_detail.phone}}</td>
		  		       </tr>
		  		       <tr>
		  		         <th width="15%">음식종류</th>
		  		         <th width="55%">{{food_detail.type}}</td>
		  		       </tr>
		  		       <tr>
		  		         <th width="15%">영업시간</th>
		  		         <th width="55%">{{food_detail.time}}</td>
		  		       </tr>
		  		       <tr>
		  		         <th width="15%">가격대</th>
		  		         <th width="55%">{{food_detail.price}}</td>
		  		       </tr>
		  		       <tr>
		  		         <th width="15%">좌석</th>
		  		         <th width="55%">{{food_detail.seat}}</td>
		  		       </tr>
		  		       <tr>
		  		         <th width="15%">테마</th>
		  		         <th width="55%">{{food_detail.theme}}</td>
		  		       </tr>
		  		     </table>
		  		   `
  }
  		  ...
  		  detail(fno){
  			  ...
  			  */
  			  axios.get('../food/detail_vue.do',{
	  			  ...
	  			  $('#dialog').dialog({
	  				  autoOpen:false,
	  				  modal:true,    // modal:false => 창 여러개 띄울수있음
	  				  width:800,
	  				  height:500
	  			  }).dialog("open")
  			  }).catch(error=>{
