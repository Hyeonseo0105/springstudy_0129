     ...
     <tr>
      <td>
        <table class="table" v-for="rvo in reply_list">
         ...
         <tr style="display: none" :id="'u_msg'+rvo.no" class="ups">
           <td colspan="2">
             <textarea rows="4" cols="85" ref="msg" style="float: left">{{rvo.msg}}</textarea>
             <input type=button value="댓글쓰기" class="btn-danger" style="float: left;width: 80px;height: 86px" @click="replyUpdate(rvo.no)">
          </td>
        </tr>
        </table>
      </td>
    ...
    <table class="table" v-if="sessionId">
      <tr>
       <td colspan="2">
         ...
         <input type=button value="댓글수정" class="btn-danger" style="float: left;width: 80px;height: 86px" @click="replyInsert()">
       </td>
      </tr>
    </table>
  </main>
